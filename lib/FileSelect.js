...
class FileSelect {
  ...
  createFileInput() {
    ...
    if (this.fileInput.multiple) this.fileInput.multiple = 'true';
  ...
  static getPDF(url) {
    return new Promise((resolve) =>
      Promise.all(/*! import() | pdfjs */[__webpack_require__.e("vendors-node_modules_pdfjs-dist_webpack_js"), __webpack_require__.e("pdfjs")]).then(__webpack_require__.t.bind(__webpack_require__, /*! pdfjs-dist/webpack */ "./node_modules/pdfjs-dist/webpack.js", 23)).then((pdfjsLib) => {

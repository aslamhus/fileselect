...
var f=c.checkFileTypes(a,c.allowedTypes||b);f.valid||e(new Error(f.message)),c.readFile(a,d,e)})}},{key:"getIcon",value:function(){var b=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function b(c){var d,e,f,g,h,i,j;return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:if(e=c.type.split("/"),f=_slicedToArray(e,1),g=f[0],h=a.getExtensionFromFilename(c.name),!(this.svg.hasOwnProperty("default")||this.svg.hasOwnProperty(g))){b.next=12;break}return i=this.svg["default"]||this.svg[g],b.next=6,a.createSVGBlob(i);case 6:j=b.sent,d=document.createElement("img"),d.src=URL.createObjectURL(j),d.onload=URL.revokeObjectURL(j),b.next=15;break;case 12:return b.next=14,this.fileIcon.create(h);case 14:d=b.sent;case 15:return b.abrupt("return",d);case 16:case"end":return b.stop();}},b,this)}));return function getIcon(){return b.apply(this,arguments)}}()/**

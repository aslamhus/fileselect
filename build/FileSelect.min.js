...
return Date.now()}/**
    ...
    */},{key:"handleFile",value:function handleFile(a,b){var c=this;return new Promise(function(d,e){"object"===_typeof(a)&&a instanceof File||e("Invalid Argument Exception. Expected instance of file.");var f;f=void 0===a.name?c.uuidv4():a.name.replace(/(?=\.[^.]+$)/,"-"+c.uuidv4()),a.uuid=f;var g=c.checkFileTypes(a,b);return g.valid?void c.readFile(a,d,e):g})}/**

...
/* harmony export */   "FileSelect": () => (/* binding */ FileSelect)
/* harmony export */ });
...
/* harmony import */ var _aslamhus_fileicon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @aslamhus/fileicon */ "./node_modules/@aslamhus/fileicon/build/FileIcon.cjs");
...
var FileSelect = /*#__PURE__*/function () {
  function FileSelect() {
    ...
    this.fileIcon = new _aslamhus_fileicon__WEBPACK_IMPORTED_MODULE_2__.FileIcon({
  ...
  _createClass(FileSelect, [{
    ...
    value: function select() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.fileInput.onchange = function (e) {
          var files = e.target.files; // convert filelist to array

          var fileListArray = Array.from(files); // add files to fileList
    ...
    value: function handleFile(file, allowedTypes) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var uuidFileName = (file === null || file === void 0 ? void 0 : file.name) !== undefined ? file === null || file === void 0 ? void 0 : file.name.replace(/(?=\.[^.]+$)/, "-".concat(Date.now())) : Date.now(); // remove spaces if there are any

        uuidFileName = uuidFileName.replace(/\s+/g, '-');
        f.uuid = uuidFileName; // check filetype is allowed
        ...
        if (file.type.toLowerCase().includes('heic') || file.type.toLowerCase().includes('heif')) {
          ...
          if (file.heicConvert) {
            ...
            file.heicConvert.then(function (blob) {
              var newFile = FileSelect.blobToFile(blob, f); // read file
    ...
    value: function createAudioElement(url, type) {
      ...
      aud.oncanplaythrough = function () {// URL.revokeObjectURL(url);
      };
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return __webpack_require__.e(/*! import() | heic2any */ "heic2any").then(__webpack_require__.t.bind(__webpack_require__, /*! heic2any */ "./node_modules/heic2any/dist/heic2any.js", 23));
    ...
    value: function getPDF(url) {
      return new Promise(function (resolve) {
        return Promise.all(/*! import() | pdfjs */[__webpack_require__.e("vendors-node_modules_pdfjs-dist_webpack_js"), __webpack_require__.e("pdfjs")]).then(__webpack_require__.t.bind(__webpack_require__, /*! pdfjs-dist/webpack */ "./node_modules/pdfjs-dist/webpack.js", 23)).then(function (pdfjsLib) {
...
/* harmony export */ });
/* harmony import */ var _FileSelect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../FileSelect */ "./src/FileSelect.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var selectAndGetFiles = function selectAndGetFiles() {
  ...
  example.querySelector('button').onclick = function (e) {
    ...
    var fileSelect = new _FileSelect__WEBPACK_IMPORTED_MODULE_0__.FileSelect();
...
var restrictFileType = function restrictFileType() {
  ...
  example.querySelector('button').onclick = function (e) {
    var preview = example.querySelector('.preview');
    var fileSelect = new _FileSelect__WEBPACK_IMPORTED_MODULE_0__.FileSelect('application/pdf');
    fileSelect.select().then(function (fileList) {
      var fileArray = fileList.toArray();
      writeArrayOfObjectstoContainer(fileArray, 'name', preview);
    })["catch"](function (error) {
...
var restrictFileTypeMultiple = function restrictFileTypeMultiple() {
  ...
  example.querySelector('button').onclick = function (e) {
    var preview = example.querySelector('.preview');
    var fileSelect = new _FileSelect__WEBPACK_IMPORTED_MODULE_0__.FileSelect(['image/jpeg', 'images/png']);
    fileSelect.select().then(function (fileList) {
      var fileArray = fileList.toArray();
      writeArrayOfObjectstoContainer(fileArray, 'name', preview);
    })["catch"](function (error) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body,\nhtml {\n  padding: 2rem;\n}\n.preview {\n  background-color: #dedede;\n}\nbutton {\n  margin: 0.55rem 0 !important;\n}\n.preview p {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.example {\n  border: 1px solid lightgray;\n  padding: 1.5rem;\n  margin: 2rem 0;\n}\nspan.method {\n  background-color: lightgoldenrodyellow;\n  font-style: normal;\n}\nvideo,\nimg {\n  width: 100px;\n}\n\n@media only screen and (min-device-width: 340px) and (max-device-width: 480px) {\n  body,\n  html {\n    padding: 1rem 0.55rem !important;\n  }\n  .example {\n    padding: 0.75rem 0.5rem;\n    border: none;\n  }\n  pre {\n    padding: 0.5rem !important;\n    position: relative;\n  }\n  code {\n    position: relative;\n    left: -50px !important;\n    font-size: 0.75rem !important;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/about/about.css"],"names":[],"mappings":"AAAA;;EAEE,aAAa;AACf;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,4BAA4B;AAC9B;AACA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;AACzB;AACA;EACE,2BAA2B;EAC3B,eAAe;EACf,cAAc;AAChB;AACA;EACE,sCAAsC;EACtC,kBAAkB;AACpB;AACA;;EAEE,YAAY;AACd;;AAEA;EACE;;IAEE,gCAAgC;EAClC;EACA;IACE,uBAAuB;IACvB,YAAY;EACd;EACA;IACE,0BAA0B;IAC1B,kBAAkB;EACpB;EACA;IACE,kBAAkB;IAClB,sBAAsB;IACtB,6BAA6B;EAC/B;AACF","sourcesContent":["body,\nhtml {\n  padding: 2rem;\n}\n.preview {\n  background-color: #dedede;\n}\nbutton {\n  margin: 0.55rem 0 !important;\n}\n.preview p {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.example {\n  border: 1px solid lightgray;\n  padding: 1.5rem;\n  margin: 2rem 0;\n}\nspan.method {\n  background-color: lightgoldenrodyellow;\n  font-style: normal;\n}\nvideo,\nimg {\n  width: 100px;\n}\n\n@media only screen and (min-device-width: 340px) and (max-device-width: 480px) {\n  body,\n  html {\n    padding: 1rem 0.55rem !important;\n  }\n  .example {\n    padding: 0.75rem 0.5rem;\n    border: none;\n  }\n  pre {\n    padding: 0.5rem !important;\n    position: relative;\n  }\n  code {\n    position: relative;\n    left: -50px !important;\n    font-size: 0.75rem !important;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./node_modules/@aslamhus/fileicon/build/FileIcon.cjs":
/*!************************************************************!*\
  !*** ./node_modules/@aslamhus/fileicon/build/FileIcon.cjs ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "@aslamhus/fileselect:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_aslamhus_fileselect"] = self["webpackChunk_aslamhus_fileselect"] || [];
